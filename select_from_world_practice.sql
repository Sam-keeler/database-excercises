...
# the continent 'South America'. Divide the 
...
# Two ways to be big: A country is big if it has an area of
...
# of the continent 'South America'. Use the ROUND function to show the values
