...
SELECT CONCAT(c.first_name, ' ', c.last_name) AS 'Employee Name', dept_name AS 'Department', CONCAT(managers.first_name, ' ', managers.last_name) AS 'Manager'
FROM employees AS c
JOIN dept_emp ON (c.emp_no = dept_emp.emp_no)
